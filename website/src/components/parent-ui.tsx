        ...
        <div className="space-y-4">
          <div className="rounded-3xl border border-white/10 bg-white/5 p-5">
            <div className="flex items-center justify-between gap-4">
              ...
              <span className="rounded-full border border-white/10 bg-slate-950/20 px-3 py-1 text-xs font-semibold uppercase tracking-[0.16em] text-[var(--parent-muted)]">Mock only</span>
            </div>
